...
public class Widget {
    ...
    ~Widget() {
        if (handle != null) { g_object_unref(handle); }
    }
    ...
    public GtkWidget* Handle() { return handle; }
    ...
    public bool IsVisible() { return gtk_widget_get_visible(handle) != 0; }
    ...
    public bool IsEnabled() { return gtk_widget_get_sensitive(handle) != 0; }
...
public class Label : Widget {
    ...
    public String Text() { return Text.FromNullTerminated(gtk_label_get_text(handle)); }
...
public class Entry : Widget {
    ...
    public String Text() { return Text.FromNullTerminated(gtk_entry_get_text(handle)); }
...
public class CheckBox : Button {
    ...
    public bool IsChecked() { return gtk_toggle_button_get_active(handle) != 0; }
...
public class TextArea : Widget {
    ...
    public TextArea() {
        ...
        buffer = gtk_text_view_get_buffer(handle);
    }
    ...
    public String Text() {
        ...
        gchar* raw = gtk_text_buffer_get_text(buffer, &start, &stop, 0);
...
public class ComboBox : Widget {
    ...
    public int SelectedIndex() { return gtk_combo_box_get_active(handle); }
...
public class ProgressBar : Widget {
    ...
    public double Fraction() { return gtk_progress_bar_get_fraction(handle); }
...
public class SpinBox : Widget {
    ...
    public double Value() { return gtk_spin_button_get_value(handle); }
    public int    IntegerValue() { return gtk_spin_button_get_value_as_int(handle); }
...
public class Notebook : Container {
    ...
    public int  CurrentPage() { return gtk_notebook_get_current_page(handle); }
...
public class StatusBar : Widget {
    ...
    public StatusBar() {
        ...
        context = gtk_statusbar_get_context_id(handle, "stainless");
    }
    ...
    public void SetText(String text) {
        gtk_statusbar_pop(handle, context);
        gtk_statusbar_push(handle, context, text.ToPointer());
    }
}
...
public static class Dialogs {
    ...
    public static Answer Ask(Window parent, String title, String message) {
        ...
        if (response == GTK_RESPONSE_YES) { return Yes; }
        if (response == GTK_RESPONSE_NO)  { return No; }
        return Cancelled;
    }
...
public class Application {
    ...
    public bool Start() {
        started = gtk_init_check(null, null) != 0;
        return started;
    }
