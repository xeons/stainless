...
public const uint AtBitSize         = 0x0Du;
...
public const uint AtDataBitOffset   = 0x6Bu;
...
public String AttributeName(uint at)
{
    switch (at)
    {
        ...
        case AtBitSize: return "DW_AT_bit_size";
        ...
        case AtDataBitOffset: return "DW_AT_data_bit_offset";
