...
export "C" nuint HeaderSize() => sizeof(Header);
export "C" nuint SignedSize() => sizeof(Signed);
export "C" nuint MixedSize() => sizeof(Mixed);

export "C" uint ReadVersion(Header header) => header.Version;
export "C" uint ReadKind(Header header) => header.Kind;
export "C" uint ReadLength(Header header) => header.Length;

export "C" int ReadSmall(Signed value) => value.Small;
export "C" int ReadLarger(Signed value) => value.Larger;

export "C" double ReadWeight(Mixed mixed) => mixed.Weight;
export "C" uint ReadMore(Mixed mixed) => mixed.More;
