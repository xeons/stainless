...
export "C" Shape MakeCircle(double radius) => Shape.Circle(radius);
export "C" Shape MakeRect(double width, double height) => Shape.Rect(width, height);
export "C" Shape MakeEmpty() => Shape.Empty;
