...
public class ThreadingTests
{
    ...
    [InlineData("ReaderWriterLock<long>", "new ReaderWriterLock<long>(0)")]
    ...
    /// </summary>
    [Theory]
    [InlineData("var m = new Monitor<long>(0); var g = m.Enter(); g.SetValue(1); g.Pulse(); g.PulseAll();")]
    [InlineData("var m = new Monitor<long>(0); var g = m.Enter(); bool b = g.WaitFor(1u); long v = g.Value;")]
    [InlineData("var l = new ReaderWriterLock<long>(0); var r = l.EnterReadLock(); long v = r.Value;")]
    [InlineData("var l = new ReaderWriterLock<long>(0); var w = l.EnterWriteLock(); w.SetValue(1);")]
    [InlineData("var l = new ReaderWriterLock<long>(0); var r = l.TryEnterReadLock(); var w = l.TryEnterWriteLock();")]
    [InlineData("var s = new Semaphore(2); s.Wait(); s.Release(); s.Release(2); bool t = s.TryWait();")]
    [InlineData("var s = new Semaphore(2); bool got = s.WaitFor(1u); long free = s.CurrentCount;")]
