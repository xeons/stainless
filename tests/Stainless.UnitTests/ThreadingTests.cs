...
public class ThreadingTests
{
    ...
    [InlineData("var l = new RwLock<long>(0); var r = l.EnterReadLock(); long v = r.Value;")]
    [InlineData("var l = new RwLock<long>(0); var w = l.EnterWriteLock(); w.SetValue(1);")]
    [InlineData("var l = new RwLock<long>(0); var r = l.TryEnterReadLock(); var w = l.TryEnterWriteLock();")]
