...
## What it is far enough along to build
...
back out of the message meant for a person.

![The IDE on Windows, Win32 backend](docs/images/ide-windows.png)

![The IDE on Linux, GTK 3 backend](docs/images/ide-linux.png)

The same program on both, from the same source and one `stainless build
...
docs/images/           the screenshots the pages above use
...
tests/Stainless.Fuzz   a fuzzer: mutated programs, looking for crashes
```
